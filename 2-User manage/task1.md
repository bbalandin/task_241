...
Ответ: Снимок в файле <span style="color:blue;">task 1.1.png</span>

2) Назначьте пользователю 1 группу администраторов, польователя 2 добавте в группу пользователя 1
Ответ: Снимок в файле <span style="color:blue;">task 1.2.png</span>
...
Ответ: Снимок в файле <span style="color:blue;">task 1.4.png</span>
