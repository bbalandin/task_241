...
Ответ: Команда cat /proc/cpuinfo показывает информацию о процессоре, cat /proc/meminfo выводит информацию о состоянии памяти. Пример вывода показан в файле <span style="color:blue;">task 3.1.7.png и task 3.1.7(2).png</span> В первом файле вывод для процессора, во втором для памяти