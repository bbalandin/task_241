...
Ответ: При помощи vi изменил содержимое файла ~/.ssh/config фото:<span style="color:blue;">task 7.2.3.png</span>
...
Ответ: Проверил работоспособность: <span style="color:blue;">task 7.2.5.png</span>